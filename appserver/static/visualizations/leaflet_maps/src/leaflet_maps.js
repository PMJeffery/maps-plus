define([
    ...
    return SplunkVisualizationBase.extend({
        ...
        tileLayer: null,
		mapOptions: {},
        contribUri: '/en-US/static/app/maps_plus/visualizations/leaflet_maps/contrib/',
        defaultConfig:  {
            'display.visualizations.custom.maps_plus.leaflet_maps.cluster': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.allPopups': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.multiplePopups': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.animate': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.singleMarkerMode': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.maxClusterRadius': 80,
            'display.visualizations.custom.maps_plus.leaflet_maps.maxSpiderfySize': 100,
            'display.visualizations.custom.maps_plus.leaflet_maps.spiderfyDistanceMultiplier': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.mapTile': 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
            'display.visualizations.custom.maps_plus.leaflet_maps.mapTileOverride': "",
            'display.visualizations.custom.maps_plus.leaflet_maps.mapAttributionOverride': "",
            'display.visualizations.custom.maps_plus.leaflet_maps.layerControl' : 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.layerControlCollapsed': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.scrollWheelZoom': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.fullScreen': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.drilldown': 0,
			'display.visualizations.custom.maps_plus.leaflet_maps.contextMenu': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.defaultHeight': 600,
            'display.visualizations.custom.maps_plus.leaflet_maps.autoFitAndZoom': 1,
			'display.visualizations.custom.maps_plus.leaflet_maps.autoFitAndZoomDelay': 500,
            'display.visualizations.custom.maps_plus.leaflet_maps.mapCenterZoom': 6,
            'display.visualizations.custom.maps_plus.leaflet_maps.mapCenterLat': 39.50,
            'display.visualizations.custom.maps_plus.leaflet_maps.mapCenterLon': -98.35,
            'display.visualizations.custom.maps_plus.leaflet_maps.minZoom': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.maxZoom': 19,
            'display.visualizations.custom.maps_plus.leaflet_maps.permanentTooltip': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.stickyTooltip': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.googlePlacesSearch': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.googlePlacesApiKey': "",
            'display.visualizations.custom.maps_plus.leaflet_maps.googlePlacesZoomLevel': "12",
			'display.visualizations.custom.maps_plus.leaflet_maps.googlePlacesPosition': "topleft",
            'display.visualizations.custom.maps_plus.leaflet_maps.kmlOverlay' : "",
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeOneBgColor': "#B5E28C",
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeOneFgColor': "#6ECC39",
            'display.visualizations.custom.maps_plus.leaflet_maps.warningThreshold': 55,
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeTwoBgColor': "#F1D357",
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeTwoFgColor': "#F0C20C",
            'display.visualizations.custom.maps_plus.leaflet_maps.criticalThreshold': 80,
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeThreeBgColor': "#FD9C73",
            'display.visualizations.custom.maps_plus.leaflet_maps.rangeThreeFgColor': "#F18017",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureTool': 1,
            'display.visualizations.custom.maps_plus.leaflet_maps.measureIconPosition': "topright",
            'display.visualizations.custom.maps_plus.leaflet_maps.measurePrimaryLengthUnit': "feet",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureSecondaryLengthUnit': "miles",
            'display.visualizations.custom.maps_plus.leaflet_maps.measurePrimaryAreaUnit': "acres",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureSecondaryAreaUnit': "sqmiles",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureActiveColor': "#00ff00",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureCompletedColor': "#0066ff",
            'display.visualizations.custom.maps_plus.leaflet_maps.measureLocalization': "en",
            'display.visualizations.custom.maps_plus.leaflet_maps.showPathLines': 0,
            'display.visualizations.custom.maps_plus.leaflet_maps.pathIdentifier': "",
            'display.visualizations.custom.maps_plus.leaflet_maps.pathColorList': "#0003F0,#D43C29,darkgreen,0xe2d400,darkred,#23A378",
            'display.visualizations.custom.maps_plus.leaflet_maps.refreshInterval': 0
        },
        ATTRIBUTIONS: {
        ...
        initialize: function() {
            ...
            $.ajax({
                ...
                async: false,
                context: this,
                url: "/en-US/splunkd/__raw/servicesNS/nobody/maps_plus/server/info",
                success: function(s) {                                        
                    var xml = $(s);
                    var that = this;
